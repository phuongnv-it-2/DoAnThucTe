          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route element={<RoleRoute allow={["ADMIN"]} />}>
              <Route path="/admin" element={<MainLayout />}>
                ...
                <Route
                  path="pos"
                  element={<ComingSoon title="Bán hàng (POS)" />}
                />
                <Route
                  path="products"
                ...
                <Route
                  path="shifts"
                  element={<ComingSoon title="Ca làm việc" />}
                />
                <Route
                  path="invoices"
            ...
            <Route element={<RoleRoute allow={["MANAGER"]} />}>
              <Route path="/manager" element={<MainLayout />}>
                ...
                <Route
                  ...
                  element={<ComingSoon title="Nhân viên" />}
                />
                <Route path="shifts" element={<ComingSoon title="Ca làm" />} />
                <Route
                  path="invoices"
                  element={<ComingSoon title="Hóa đơn" />}
                />
            ...
            <Route element={<RoleRoute allow={["STAFF"]} />}>
              <Route path="/staff" element={<MainLayout />}>
                ...
                <Route
                  ...
                  element={<ComingSoon title="Đơn in" />}
                />
                <Route path="shift" element={<ComingSoon title="Ca làm" />} />
              </Route>
            </Route>
